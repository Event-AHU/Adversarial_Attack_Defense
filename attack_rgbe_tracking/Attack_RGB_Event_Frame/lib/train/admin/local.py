class EnvironmentSettings:
    def __init__(self):
        self.workspace_dir = '/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c01/DATA/chenqiang/event_attack/event_CEUTrack/output/checkpoints'    # Base directory for saving network checkpoints.
        self.tensorboard_dir = '/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c01/DATA/chenqiang/event_attack/event_CEUTrack/output/tensorboard'    # Directory for tensorboard files.
        self.pretrained_networks = '/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c01/DATA/chenqiang/event_attack/event_CEUTrack/pretrained_models'
