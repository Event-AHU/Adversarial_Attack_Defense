...
class COESOTDataset(BaseDataset):
    ...
    def _get_sequence_list(self, split):
        frame_path = "/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c01/DATA/chenqiang/RGB_Event_Frame_Attack/event_CEUTrack/visual/ceosot/00"

        with open('{}/Frame.txt'.format(frame_path)) as f:
