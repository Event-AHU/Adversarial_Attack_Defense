...
def getCAM(features, img, idx,senqice_name):      
    base_path =  '/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c01/DATA/chenqiang/AttackTracking/CEUTrack/visual/CAM/noise'  ## Please define the save path yourself.                                                                   
    save_path = os.path.join(base_path, senqice_name)
