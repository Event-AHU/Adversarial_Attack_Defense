...
from ours.probability_space.event_generator.gumbel_torch import (
    GumbelSoftmaxTorch,
)
from utils.init_alpha import get_alpha
from utils.init_alpha import init_alpha_from_frame
...
class ProbabilityAttacker(nn.Module):
    def __init__(
        ...
        self.lamda = attack_cfg["lamda"] #权重参数
    ...
    def forward(self):
        ...
        if self.use_soft_event:
            ...
            soft_frame = None
        hard_frame = self.frame_processor( #用hard
