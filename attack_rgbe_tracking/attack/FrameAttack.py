...
def main():
    ...
    for epoch in range(10):
        log_file = '/media/amax/c08a625b-023d-436f-b33e-9652dc1bc7c01/DATA/chenqiang/RGB_Event_Frame_Attack/event_CEUTrack/output/test/tracking_results/logs/nips.log'
