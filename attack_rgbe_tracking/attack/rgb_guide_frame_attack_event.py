...
def main():
    ...
    for epoch in range(10):
        log_file = '/wangx/DATA/Code/chenqiang/Attack/RGB_Event_Frame_Attack/event_CEUTrack/output/test/tracking_results/logs/attack_event.log'
